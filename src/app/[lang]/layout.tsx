...
import { generateStructuredData, organizationSchema, websiteSchema, softwareApplicationSchema } from '@/lib/json-ld'
...
const CustomNavbar = async ({ lang }: I18nLangAsyncProps) => {
  return (
    <Navbar
      ...
      logoLink={`/${lang}`}
      projectLink={repo}
      chatLink="https://discord.gg/vukXDGT7n5"
    >
      <>
      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            generateStructuredData([organizationSchema, websiteSchema, softwareApplicationSchema])
          ),
        }}
      />
        ...
        <Script id="posthog-init" strategy="afterInteractive">
          {`
              ...
              posthog.init('${process.env.NEXT_PUBLIC_POSTHOG_KEY}', {
                api_host: '${process.env.NEXT_PUBLIC_POSTHOG_HOST || 'https://phg.xpay.sh'}',
