...
<div className="nx-text-center nx-mt-8 nx-mb-12">
  <p className="nx-text-lg nx-text-gray-600 nx-max-w-2xl nx-mx-auto">
    Dedicated infrastructure for the x402 payment protocol ecosystem. Essential tools that sit between AI agents and autonomous payments, ensuring agents never overspend while enabling instant API monetization.
  </p>
</div>

## What is \{xpay✦\}?

\{xpay✦\} is building the essential infrastructure for the x402 payment protocol ecosystem. We provide developers and businesses with the tools they need to safely integrate autonomous payments while enabling instant API monetization.
...
### 🛡️ x402 Agent Firewall
**Cost Control Dashboard**

Developers are concerned about their agents getting stuck in spending loops. Our firewall provides AWS proxy endpoints with hard spending limits, real-time alerts, and per-agent budgets.

[Learn more →](/products/agent-firewall)
...
await firewall.protectedFetch('https://api.example.com/expensive-ai-service')
```
