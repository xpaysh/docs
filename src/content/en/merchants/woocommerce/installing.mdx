...
Two ways to install: from the [WordPress.org plugin directory](https://wordpress.org/plugins/agentic-commerce-for-woocommerce/) (recommended — approved and live), or by uploading the zip from `install.xpay.sh`.
...
See [Connecting your store](/merchants/woocommerce/connecting).
...
4. It surfaces the [first-activation consent notice](/merchants/woocommerce/privacy-telemetry) asking whether you want to share anonymous lifecycle telemetry. Default: **off**.
...
→ [Generate your WooCommerce REST API keys](/merchants/woocommerce/rest-api-keys) (required for the connect step)
