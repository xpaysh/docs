...
Specific symptoms, specific fixes. If your issue isn't here, email **merchants@xpay.sh** or open a [GitHub issue](https://github.com/xpaysh/agentic-commerce-for-woocommerce/issues).
...
- PHP version below 7.4 — see [System requirements](/merchants/woocommerce/installing#system-requirements)
...
| WC REST key has wrong permission | Regenerate with **Read** permission ([guide](/merchants/woocommerce/rest-api-keys)). |
...
- Or open a [GitHub issue](https://github.com/xpaysh/agentic-commerce-for-woocommerce/issues).
