...
<Callout type="info">
**Latest version:** v0.1.7 · **Free** until first AI-attributable sale · [Download zip](https://install.xpay.sh/woocommerce/latest.zip) · [Source on GitHub](https://github.com/xpaysh/xpay-for-woocommerce)
</Callout>
...
- **Source:** [github.com/xpaysh/xpay-for-woocommerce](https://github.com/xpaysh/xpay-for-woocommerce)
- **Issue tracker:** [GitHub Issues](https://github.com/xpaysh/xpay-for-woocommerce/issues)
...
```text
xpay-for-woocommerce/
├── xpay-for-woocommerce.php        Main plugin file (Plugin header + bootstrap)
