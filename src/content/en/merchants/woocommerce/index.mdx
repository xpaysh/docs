...
**Latest version:** v0.3.1 · **Free** to install · [Download zip](https://install.xpay.sh/woocommerce/latest.zip) · [Source on GitHub](https://github.com/xpaysh/agentic-commerce-for-woocommerce)
</Callout>
...
- It **doesn't require a new account** to start. Free to install. [Pricing](https://www.xpay.sh/pricing/?tab=agentic-commerce).
