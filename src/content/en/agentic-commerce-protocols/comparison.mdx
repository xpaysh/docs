...
- Payment rails — [MPP](https://mpp.dev), [x402](https://x402.org), cards / stablecoins
- xpay.sh protocol pages — [ACP](https://www.xpay.sh/protocols/acp/) · [UCP](https://www.xpay.sh/protocols/ucp/) · [AP2](https://www.xpay.sh/protocols/ap2/)
- For merchants — [xpay.sh/merchants](https://www.xpay.sh/merchants/) · [Shopify](https://www.xpay.sh/merchants/shopify) · [WooCommerce](https://www.xpay.sh/merchants/woocommerce/)
