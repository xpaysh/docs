...
Scoped for follow-up: a proposal to add an **x402 payment-method binding** so UCP carts can settle in USDC via the existing payment-method abstraction. Not yet filed upstream — open a thread in the UCP discussions if you'd like to co-design it.

## See also

- [Comparison page →](/agentic-commerce-protocols/comparison)
- [ACP](/agentic-commerce-protocols/acp)
- [AP2](/agentic-commerce-protocols/ap2)
- [xpay facilitator](/x402-protocol/facilitator) — the x402 settlement layer UCP can call into
