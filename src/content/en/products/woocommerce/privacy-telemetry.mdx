...
> **xpay for WooCommerce — help us improve onboarding**
>
...
| Code | What it does |
|---|---|
| [`includes/class-xpay-telemetry.php`](https://github.com/xpaysh/xpay-for-woocommerce/blob/main/includes/class-xpay-telemetry.php) | Telemetry payload + opt-in gate |
| [`includes/class-xpay-consent.php`](https://github.com/xpaysh/xpay-for-woocommerce/blob/main/includes/class-xpay-consent.php) | First-activation consent UI |
| [`includes/class-xpay-client.php`](https://github.com/xpaysh/xpay-for-woocommerce/blob/main/includes/class-xpay-client.php) | JWT verify for cart deeplinks |
| [`includes/class-xpay-cart.php`](https://github.com/xpaysh/xpay-for-woocommerce/blob/main/includes/class-xpay-cart.php) | Cart deeplink handler |
