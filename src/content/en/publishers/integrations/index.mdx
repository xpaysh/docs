...
<Cards>
  <Card title="Cloudflare" href="/en/publishers/integrations/cloudflare">
    Redirect Rules (all plans) or Workers. Most publishers use this.
  </Card>
  <Card title="Fastly" href="/en/publishers/integrations/fastly">
    VCL-based bot detection and redirect.
  </Card>
  <Card title="Akamai" href="/en/publishers/integrations/akamai">
    Edge Redirector / Cloudlets for bot routing.
  </Card>
  <Card title="AWS CloudFront" href="/en/publishers/integrations/aws-cloudfront">
    WAF rules + CloudFront Functions for bot detection.
  </Card>
</Cards>
